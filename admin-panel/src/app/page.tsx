...
type PlanOption = "Starter" | "Growth" | "Enterprise" | "Custom";
type StatusOption = "Active" | "Pending" | "Trial" | "Churn Risk" | "Offboarded";

const PLAN_OPTIONS: PlanOption[] = ["Starter", "Growth", "Enterprise", "Custom"];
...
const statusBadgeStyles: Record<StatusOption, string> = {
...
const planBadgeStyles: Record<PlanOption, string> = {
...
export default function AdminDashboard() {
  ...
  const handleEditPlaceholder = () => {
    setMessage("Editing will be available soon.");
  };
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
              ...
              <select
                value={statusFilter}
                onChange={(event) =>
                  setStatusFilter(event.target.value as "All" | StatusOption)
                }
                      ...
                      <td className="px-5 py-4">
                        <div className="flex flex-wrap items-center gap-2">
                          <button
                            ...
                            className="inline-flex items-center rounded-full border border-slate-200 px-3 py-1.5 text-xs font-semibold text-slate-600 transition hover:border-blue-200 hover:text-blue-600"
                          >
                            Edit
                          </button>
                          <button
          ...
          <form className="mt-6 grid gap-5" onSubmit={handleSubmit}>
            ...
            <div className="grid gap-5 md:grid-cols-2">
              <div className="space-y-2">
                ...
                <select
                  ...
                  value={form.plan}
                  onChange={(event) =>
                    handleChange("plan", event.target.value as PlanOption)
                  }
            ...
            <div className="flex justify-end">
              <button
                type="submit"
                disabled={submitting}
                className="inline-flex w-full items-center justify-center rounded-full bg-slate-900 px-6 py-3 text-sm font-semibold text-white shadow-sm transition hover:bg-slate-700 focus:outline-none focus-visible:ring-2 focus-visible:ring-slate-400 disabled:cursor-not-allowed disabled:bg-slate-400 md:w-auto"
              >
